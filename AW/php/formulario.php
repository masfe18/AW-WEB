     ...
     <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Equipo de futbol</a>
        </div>
    ...
    <div class="container">
	 ...
	 <form method="post" action="insert.php">
                <div class="form-group">
                  ...
                  <input type="text" id="nom" class="form-control" placeholder="Nombre del equipo" name="nom">
                </div>
                <div class="form-group">
                  <label for="usr">Localitat:</label>
                  <input type="text" id="localitat" class="form-control" placeholder="Localidad" name="localitat">
                </div>
                <div class="form-group">
                  <label for="usr">Pagina web</label>
                  <input type="text" id="web" class="form-control" placeholder="Web" name="web">
                </div>
                <div class="form-group">
                  <label for="usr">Escudo</label>
                  <input type="text" id="escut" class="form-control" placeholder="Escudo" name="escut">
                </div>
